            ...
            <div className="mt-12 flex flex-col items-center">
              ...
              <div className="mt-8 w-full flex-1">
                ...
                >
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid}>
                        ...
                        <input
                          ...
                          className="w-full rounded-lg border border-gray-200 bg-gray-100 px-6 py-3 text-sm font-medium outline-none transition focus:border-indigo-400 focus:bg-white"
                        />
                  ...
                  <button
                    type="submit"
                    className="mt-5 flex w-full items-center justify-center rounded-lg bg-indigo-500 py-4 font-semibold tracking-wide text-white transition hover:bg-indigo-700"
                  >
                    Sign Up
                  </button>

                  <p className="mt-6 text-center text-xs text-gray-600">
                    I agree to abide by Gidys{" "}
                    <a
                      href="#"
